...
<body>
    ...
    <div class="ui sidebar inverted vertical menu sidebar-menu" id="sidebar">
        ...
        <a href="iniciocliente.php" class="item  active">
            <div>
        ...
        <a href="farmaciasclientes.php" class="item">
            <div>
            ...
            <div class="ui dropdown item">
                ...
                <div class="menu">
                    <a href="#" class="item">
                        ...
                        if (!empty($usuario)) {
                            echo '<div class="single line positive green"><img class="ui avatar image" src="../img/logo.png">
