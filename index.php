  ...
  <body>
    ...
    <div class="ui large top fixed hidden menu">
      <div class="ui container">
        ...
        <a class="item">Farmacias</a>
        <a class="item">Productos</a>
        <a class="item" href="modulos/login.html">Acerca de</a>
        <div class="right menu">
          <div class="item">
            <a class="ui button" href="modulos/login.html">Iniciar Sesión</a>
          </div>
          <div class="item">
        ...
        <div class="ui container">
          <div class="ui large secondary inverted pointing menu">
            ...
            <div class="right item">
              <a class="ui inverted button" href="modulos/login.php">Iniciar Sesión</a>
              <a class="ui inverted button" href="modulos/registrarse.php">Registrate</a>
            </div>
          </div>
        </div>
